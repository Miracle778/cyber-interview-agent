...
- [ ] **Step 1: Expand valid fixtures and add RED tests**
...
- [ ] **Step 3: Implement minimal profile parsing and checks**
...
- [ ] **Step 1: Rewrite the learning template around profiles**
...
- [ ] **Step 2: Update workflow and startup entry points**
...
- [ ] **Step 3: Record bounded current state**
...
- [ ] **Step 4: Validate formal documents**
...
- [ ] **Step 1: Synchronize the current local packs into the isolated worktree**
...
- [ ] **Step 2: Add profile declarations to the three depth baselines**
...
- [ ] **Step 4: Rebuild Runtime Middleware and selectively deepen Pre-R2**
...
- [ ] **Step 5: Create the settings experience pack**
...
- [ ] **Step 6: Run each pack through the new learning checker**
...
- [ ] **Step 7: Confirm ignored-artifact boundary**
...
- [ ] **Step 1: Run final script regression**

Run: `python3 -m unittest -q scripts/test_check_stage_docs.py`

Expected: all documentation-gate tests pass.

- [ ] **Step 2: Run all learning gates once**
...
- [ ] **Step 3: Perform one human depth review**
...
- [ ] **Step 4: Update task evidence and commit formal files**
