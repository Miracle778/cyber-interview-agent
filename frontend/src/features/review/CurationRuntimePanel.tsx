...
export function CurationRuntimePanel({ session, activeModelLabel = "", retrying = false, onRetry = () => undefined }: { session: CurationSession | null; activeModelLabel?: string; retrying?: boolean; onRetry?: () => void }) {
