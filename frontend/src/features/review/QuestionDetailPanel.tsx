...
export function QuestionDetailPanel({ candidate, sourceLabels, busy, approvalPending = false, onSave, onRewrite, onConfirm, onDelete, onOpenSession }: { candidate: QuestionCandidate | null; sourceLabels: Record<string, string>; busy: boolean; approvalPending?: boolean; onSave: (values: { version: number; title: string; questionText: string; referenceAnswer: string; keyPoints: string[] }) => void; onRewrite: (feedback: string) => void; onConfirm: () => void; onDelete?: () => void; onOpenSession: (candidateId: string) => void }) {
