...
const retrospective: InterviewRetrospective = { id: "retro-1", workspaceId: "w1", jobTargetId: "target-1", title: "后端一面复盘", roundLabel: "一面", interviewDate: "2026-08-01", outcome: "pending", note: "", lifecycleStatus: "active", activeSourceVersionId: "source-1", activeCleanupVersionId: "cleanup-1", activeAnalysisRunId: "run-1", version: 2, createdAt: "now", updatedAt: "now" };
