...
export function ResumeVersions({ materials, versions, selectedMaterialId, selectedVersionId, detail, busy, onSelectMaterial, onSelectVersion, onRetry, onArchive, onRestore, onSetPrimary, onPermanentDelete, onOpenEvidence, onOpenDocument, onAddVersion }: ResumeVersionsProps) {
      ...
      <section className="profile-version-detail">
        {detail ? <>
          <header className="profile-version-detail__header">
            ...
            <ProfileStatusBadge status={detail.processingStatus} lifecycle={detail.material.lifecycleStatus} />
