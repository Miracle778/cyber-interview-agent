...
| 11. Agent 上下文组装与命令解释收敛 | 设计已确认，正式文档待审阅 | 通用 token-budget ContextAssembler、持久领域焦点、确定性命令优先、一次性结构化 classifier |
...
1. 审阅 `2026-07-15-agent-context-assembly-design.md` 与对应架构选型记录。
2. 审阅通过后编写实施计划，以 TDD 迁移题库整理命令链路并删除固定 8 条上下文逻辑。
