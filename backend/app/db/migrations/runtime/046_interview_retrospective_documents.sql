CREATE TABLE knowledge_drafts_v46 (
    id TEXT PRIMARY KEY,
    ...
    document_type TEXT NOT NULL CHECK (
        document_type IN (
            'source', 'question', 'concept', 'session_report',
            'mastery_report', 'profile', 'interview_retrospective'
        )
    ),
...
INSERT INTO knowledge_drafts_v46 (
...
ALTER TABLE knowledge_drafts_v46 RENAME TO knowledge_drafts;
